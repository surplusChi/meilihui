  ...
  <div>
    <div id="newEvent">
      ...
      <div class="container clearfix">
        <div v-for="data in newEventList" :key="data.categoryId">
    ...
    <div id="hotBrand">
      ...
      <div class="container clearfix">
        <div v-for="data in hotBrandList" :key="data.categoryId">
          <img :src="data.imageUrl" alt="">
          <div class="event-base">
...
export default {
  ...
  mounted () {
    // 获取首页数据
    http({
      url: '/home/eventForH5?params=%7B%7D&timestamp=1614781687943&summary=9f970d3059aa8f7e289b123a7cf4f839&platform_code=H5'
    }).then(res => {
      // 获取今日新品数据
